...
.. csv-table:: Imagenet benchmark results.
  ...
  "LeJEPA\*\*", "ViT-S/16", "512", "100", "64.0", "85.8", "78.7", "94.5", "47.1", "74.3", "`tensorboard LeJEPA <https://lightly-ssl-checkpoints.s3.amazonaws.com/imagenet_vits16_lejepa_2026-05-20_17-59-16/pretrain/version_0/metrics_plot.png>`_", "`checkpoint LeJEPA <https://lightly-ssl-checkpoints.s3.amazonaws.com/imagenet_vits16_lejepa_2026-05-20_17-59-16/pretrain/version_0/checkpoints/epoch%3D099-val_online_cls_top1%3D0.5623.ckpt>`_"
...
\*\*The LeJEPA numbers were published in `#1935 <https://github.com/lightly-ai/lightly/pull/1935>`_ (``a08c5c35``) and predate the loss fix in `#2023 <https://github.com/lightly-ai/lightly/pull/2023>`_, which adds the global views to SIGReg and the invariance term. They will be updated after a re-run.
