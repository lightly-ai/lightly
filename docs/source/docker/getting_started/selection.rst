...
For scheduling a Lightly Worker run with a specific selection, you can use the python client and its :meth:`lightly.api.ApiWorkflowClient.schedule_compute_worker_run` method.
...
If `n_samples` is an integer, it specifies the absolute number of samples which should be selected.
If it is a float, is specifies the relative number of samples to be selected relative to the number of input samples.
E.g. if `n_samples` is **0.1** its selects 10% of the images, which means that the selected subset will have 10% of the initial dataset size.

The input for each strategy can be one of the following:
...
.. tabs::
    ...
    .. tab:: SCORES
        ...
        .. code-block:: javascript
            ...
            "input": {"type": "SCORES", "task": "lightly_pretagging", "score": "uncertainty_entropy"}
    ...
    .. tab:: METADATA
        ...
        - Custom metadata vs. Lightly metadata
            ...
            .. code-block:: javascript
                ...
                "input": {"type": "METADATA", "key": "weather.temperature"}
            ...
            .. code-block:: javascript
                ...
                "input": {"type": "METADATA", "key": "lightly.sharpness"}
    ...
    .. tab:: PREDICTIONS
        ...
        .. code-block:: javascript
            ...
            "input": {"type": "PREDICTIONS", "task": "my_object_detection_task", "name": "CLASS_DISTRIBUTION"}
...
.. tabs::
    ...
    .. tab:: DIVERSIFY
        ...
        .. code-block:: javascript
            ...
            "strategy": {"type": "DIVERSIFY", "stopping_condition_minimum_distance": 0.2}
    ...
    .. tab:: THRESHOLD
        ...
        .. code-block:: javascript
            ...
            "strategy": {"type": "THRESHOLD", "threshold": 20, "operation": "BIGGER_EQUAL"}
    ...
    .. tab:: BALANCE
        ...
        .. code-block:: javascript
            ...
            "strategy": {"type": "BALANCE", "target": {"Ambulance": 0.2, "Bus": 0.4}}
...
.. tabs::
    ...
    .. tab:: Active Learning
        ...
        .. code-block:: javascript
            ...
            {
                "input": {"type": "SCORES", "task": "my_object_detection_task", "score": "uncertainty_entropy"},
                "strategy": {"type": "WEIGHTS"}
            }
    ...
    .. tab:: Metadata Thresholding
        ...
        .. code-block:: javascript
            ...
            {
                "input": {"type": "METADATA", "key": "lightly.sharpness"},
                "strategy": {"type": "THRESHOLD", "threshold": 20, "operation": "BIGGER"}
            }
    ...
    .. tab:: Score Thresholding
        ...
        .. code-block:: javascript
            ...
            {
                "input": {"type": "SCORES", "task": "my_object_detection_task", "score": "object_frequency"},
                "strategy": {"type": "THRESHOLD", "threshold": 2, "operation": "BIGGER_EQUAL"}
            }
    ...
    .. tab:: Object Balancing
        ...
        .. code-block:: javascript
            ...
            {
                "input": {"type": "PREDICTIONS", "task": "lightly_pretagging", "name": "CLASS_DISTRIBUTION"},
                "strategy": {"type": "BALANCE", "target": {"car": 0.1, "bicycle": 0.5, "bus": 0.1, "motorcycle": 0.1, "person": 0.1, "train": 0.05, "truck": 0.05}}
            }
    ...
    .. tab:: Metadata Balancing
        ...
        .. code-block:: javascript
            ...
            {
                "input": { "type": "METADATA", "key": "weather.description"},
                "strategy": { "type": "BALANCE", "target": {"sunny": 0.2, "cloudy": 0.4} }
            }
...
- Lightly metadata is generated on the fly fo the object crops and can thus be used for selection. However, other metadata is on image level and thus NOT available at the moment.
