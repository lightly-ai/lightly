...
class VersioningApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_latest_pip_version_endpoint = _Endpoint(
            settings={
                'response_type': (VersionNumber,),
                'auth': [],
                'endpoint_path': '/v1/versions/pip/latest',
                'operation_id': 'get_latest_pip_version',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_minimum_compatible_pip_version_endpoint = _Endpoint(
            settings={
                'response_type': (VersionNumber,),
                'auth': [],
                'endpoint_path': '/v1/versions/pip/minimum',
                'operation_id': 'get_minimum_compatible_pip_version',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_latest_pip_version(
        ...
        **kwargs
        ...
        return self.get_latest_pip_version_endpoint.call_with_http_info(**kwargs)

    def get_minimum_compatible_pip_version(
        self,
        **kwargs
    ):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_minimum_compatible_pip_version_endpoint.call_with_http_info(**kwargs)
