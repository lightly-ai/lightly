...
class QuotaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_quota_maximum_dataset_size_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/v1/quota',
                'operation_id': 'get_quota_maximum_dataset_size',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_quota_maximum_dataset_size(
        self,
        **kwargs
    ):
        ...
        return self.get_quota_maximum_dataset_size_endpoint.call_with_http_info(**kwargs)
