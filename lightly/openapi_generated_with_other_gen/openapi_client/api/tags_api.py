...
class TagsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_initial_tag_by_dataset_id(
            self,
            dataset_id,
        ...
        self.create_initial_tag_by_dataset_id = _Endpoint(
            settings={
            ...
            callable=__create_initial_tag_by_dataset_id
        )
        ...
        self.create_tag_by_dataset_id = _Endpoint(
            settings={
                'response_type': (CreateEntityResponse,),
                'auth': [
                    'ApiKeyAuth',
        ...
        self.get_filenames_by_tag_id = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_filenames_by_tag_id
        )

        def __get_tag_by_tag_id(
            self,
            dataset_id,
            tag_id,
            **kwargs
        ...
        self.get_tag_by_tag_id = _Endpoint(
            settings={
        ...
        self.get_tags_by_dataset_id = _Endpoint(
            settings={
                'response_type': ([TagData],),
                'auth': [
                    'ApiKeyAuth',
