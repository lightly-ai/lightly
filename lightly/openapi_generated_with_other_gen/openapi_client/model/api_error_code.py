...
class ApiErrorCode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["BAD_REQUEST", "NOT_IMPLEMENTED", "FORBIDDEN", "UNAUTHORIZED", "NOT_FOUND", "MALFORMED_REQUEST", "JOB_CREATION_FAILED", "USER_NOT_KNOWN", "USER_ACCOUNT_DEACTIVATED", "USER_ACCOUNT_BLOCKED", "TEAM_ACCOUNT_PLAN_INSUFFICIENT", "DATASET_TAG_INVALID", "EMBEDDING_NAME_EXISTS", "EMBEDDING_INVALID", "EMBEDDING_UNKNOWN", "TAG_UNKNOWN", "TAG_INITIAL_EXISTS", "TAG_PREVTAG_NOT_OF_DATASET", ]  # noqa: E501
