...
> CreateEntityResponse create_initial_tag_by_dataset_id(body, dataset_id)
...
body = lightly.openapi_generated.swagger_client.InitialTagCreateRequest() # InitialTagCreateRequest | 
dataset_id = lightly.openapi_generated.swagger_client.MongoObjectID() # MongoObjectID | ObjectId of the dataset

try:
    api_response = api_instance.create_initial_tag_by_dataset_id(body, dataset_id)
    pprint(api_response)
...
------------- | ------------- | ------------- | -------------
 **body** | [**InitialTagCreateRequest**](InitialTagCreateRequest.md)|  | 
...
# create an instance of the API class
api_instance = lightly.openapi_generated.swagger_client.TagsApi(lightly.openapi_generated.swagger_client.ApiClient(configuration))
body = lightly.openapi_generated.swagger_client.TagCreateRequest() # TagCreateRequest | 
dataset_id = lightly.openapi_generated.swagger_client.MongoObjectID() # MongoObjectID | ObjectId of the dataset
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**TagCreateRequest**](TagCreateRequest.md)|  | 
 **dataset_id** | [**MongoObjectID**](.md)| ObjectId of the dataset | 
