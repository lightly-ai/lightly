...
class DatasetsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_tag_by_dataset_id(
            self,
            dataset_id,
            inline_object1_inline_object1,
            **kwargs
        ):
            ...
            >>> thread = api.create_tag_by_dataset_id(dataset_id, inline_object1_inline_object1, async_req=True)
            >>> result = thread.get()

            Args:
                dataset_id (str): ObjectId of the dataset
                inline_object1_inline_object1 (inline_object1.InlineObject1):
            ...
            kwargs['dataset_id'] = \
                dataset_id
            kwargs['inline_object1_inline_object1'] = \
                inline_object1_inline_object1
            return self.call_with_http_info(**kwargs)

        self.create_tag_by_dataset_id = Endpoint(
            settings={
                'response_type': ([tag_data.TagData],),
                'auth': [
                    'auth0Bearer'
                ],
                'endpoint_path': '/users/datasets/{datasetId}/tags',
            ...
            root_map={
                ...
                'location_map': {
                    'dataset_id': 'path',
                    'inline_object1_inline_object1': 'body',
                },
            ...
            callable=__create_tag_by_dataset_id
        )
        ...
        self.get_dataset_by_id = Endpoint(
            settings={
                'response_type': (dataset_data.DatasetData,),
                'auth': [
                    'auth0Bearer'
                ],
        ...
        self.get_embeddings_csv_write_url_by_id = Endpoint(
            settings={
        ...
        self.get_tags_by_dataset_id = Endpoint(
            settings={
                'response_type': ([tag_data.TagData],),
                'auth': [
                    'auth0Bearer'
            ...
            api_client=api_client,
            callable=__get_tags_by_dataset_id
        )
