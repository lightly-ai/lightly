...
from lightly.openapi_generated.openapi_client.models import annotation_data
...
class AnnotationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_annotation_by_id = Endpoint(
            settings={
                'response_type': (annotation_data.AnnotationData,),
                'auth': [
                    'auth0Bearer'
                ],
        ...
        self.get_annotations_by_dataset_id = Endpoint(
            settings={
                'response_type': ([annotation_data.AnnotationData],),
                'auth': [
                    'auth0Bearer'
