    ...
    def from_dict(cls, obj: dict) -> PredictionSingletonObjectDetectionAllOf:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in PredictionSingletonObjectDetectionAllOf) in the input: "
                    + str(obj)
                )

        _obj = PredictionSingletonObjectDetectionAllOf.parse_obj(
            {"bbox": obj.get("bbox"), "probabilities": obj.get("probabilities")}
        )
        return _obj
