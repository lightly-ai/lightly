...
class SelectionConfigV4EntryInput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SelectionConfigV4EntryInput:
        """Create an instance of SelectionConfigV4EntryInput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SelectionConfigV4EntryInput:
        """Create an instance of SelectionConfigV4EntryInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SelectionConfigV4EntryInput.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SelectionConfigV4EntryInput) in the input: " + str(obj))

        _obj = SelectionConfigV4EntryInput.parse_obj({
            "type": obj.get("type"),
            "task": obj.get("task"),
            "score": obj.get("score"),
            "key": obj.get("key"),
