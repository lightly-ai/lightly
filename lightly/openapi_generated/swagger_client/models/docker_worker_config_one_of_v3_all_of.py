...
class DockerWorkerConfigOneOfV3AllOf(BaseModel):
    """
    DockerWorkerConfigOneOfV3AllOf
    """
    config: DockerWorkerConfigV3 = Field(...)
    config_orig: DockerWorkerConfigV3 = Field(..., alias="configOrig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DockerWorkerConfigOneOfV3AllOf:
        """Create an instance of DockerWorkerConfigOneOfV3AllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DockerWorkerConfigOneOfV3AllOf:
        """Create an instance of DockerWorkerConfigOneOfV3AllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DockerWorkerConfigOneOfV3AllOf.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DockerWorkerConfigOneOfV3AllOf) in the input: " + str(obj))

        _obj = DockerWorkerConfigOneOfV3AllOf.parse_obj({
