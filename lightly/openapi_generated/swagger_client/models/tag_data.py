...
class TagData(BaseModel):
    ...
    prev_tag_id: Optional[constr(strict=True)] = Field(
        ...,
        alias="prevTagId",
        description="MongoObjectID or null.  Generally: The prevTagId is this tag's parent, i.e. it is a superset of this tag. Sampler: The prevTagId is the initial-tag if there was no preselectedTagId, otherwise, it's the preselectedTagId. ",
    )
    ...
    def from_dict(cls, obj: dict) -> TagData:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in TagData) in the input: "
                    + str(obj)
                )
        ...
        _obj = TagData.parse_obj(
            {
                ...
                "changes": [
                    TagChangeEntry.from_dict(_item) for _item in obj.get("changes")
                ]
