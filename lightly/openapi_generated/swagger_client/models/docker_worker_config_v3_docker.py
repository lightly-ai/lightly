...
class DockerWorkerConfigV3Docker(BaseModel):
    ...
    num_processes: Optional[conint(strict=True, ge=-1)] = Field(
        None, alias="numProcesses"
    )
    ...
    def to_dict(self, by_alias: bool = False):
        ...
        if self.training:
            _dict["training" if by_alias else "training"] = self.training.to_dict(
                by_alias=by_alias
            )
        return _dict
    ...
    def from_dict(cls, obj: dict) -> DockerWorkerConfigV3Docker:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in DockerWorkerConfigV3Docker) in the input: "
                    + str(obj)
                )
        ...
        _obj = DockerWorkerConfigV3Docker.parse_obj(
            {
                ...
                "training": DockerWorkerConfigV3DockerTraining.from_dict(
                    obj.get("training")
                )
