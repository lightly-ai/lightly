...
class TagUpsizeRequest(BaseModel):
    ...
    upsize_tag_name: constr(strict=True, min_length=3) = Field(
        ..., alias="upsizeTagName", description="The name of the tag"
    )
    ...
    def from_dict(cls, obj: dict) -> TagUpsizeRequest:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in TagUpsizeRequest) in the input: "
                    + str(obj)
                )
