...
class DatasourceRawSamplesMetadataData(BaseModel):
    ...
    data: conlist(DatasourceRawSamplesMetadataDataRow) = Field(
        ..., description="Array containing the raw samples metadata objects"
    )
    ...
    def from_dict(cls, obj: dict) -> DatasourceRawSamplesMetadataData:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in DatasourceRawSamplesMetadataData) in the input: "
                    + str(obj)
                )
        ...
        _obj = DatasourceRawSamplesMetadataData.parse_obj(
            {
                ...
                "data": [
                    DatasourceRawSamplesMetadataDataRow.from_dict(_item)
