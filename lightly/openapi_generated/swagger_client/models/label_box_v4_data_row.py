...
class LabelBoxV4DataRow(BaseModel):
    ...
    global_key: Optional[StrictStr] = Field(
        None, description="The task_id for importing into LabelBox."
    )
    media_type: Optional[StrictStr] = Field(
        None, description="LabelBox media type, e.g. IMAGE"
    )
    ...
    def from_dict(cls, obj: dict) -> LabelBoxV4DataRow:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in LabelBoxV4DataRow) in the input: "
                    + str(obj)
                )
