...
class DockerWorkerConfigOneOfV2(BaseModel):
    """
    DockerWorkerConfigOneOfV2
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DockerWorkerConfigOneOfV2:
        """Create an instance of DockerWorkerConfigOneOfV2 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DockerWorkerConfigOneOfV2:
        """Create an instance of DockerWorkerConfigOneOfV2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DockerWorkerConfigOneOfV2.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DockerWorkerConfigOneOfV2) in the input: " + str(obj))

        _obj = DockerWorkerConfigOneOfV2.parse_obj({
            "id": obj.get("id"),
