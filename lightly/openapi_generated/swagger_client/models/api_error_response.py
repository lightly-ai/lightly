...
class ApiErrorResponse(BaseModel):
    ...
    error: StrictStr = Field(
        ..., description="The detailed error message or code of the error"
    )
    request_id: Optional[StrictStr] = Field(
        None,
        alias="requestId",
        description="The identifier of a request. Helpful for debugging",
    )
    error_labels: Optional[conlist(StrictStr)] = Field(
        None, alias="errorLabels", description="Can occur on database errors"
    )
    ...
    def from_dict(cls, obj: dict) -> ApiErrorResponse:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in ApiErrorResponse) in the input: "
                    + str(obj)
                )
