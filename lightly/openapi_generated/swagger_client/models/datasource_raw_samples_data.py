...
class DatasourceRawSamplesData(BaseModel):
    ...
    data: conlist(DatasourceRawSamplesDataRow) = Field(
        ..., description="Array containing the sample objects"
    )
    ...
    def from_dict(cls, obj: dict) -> DatasourceRawSamplesData:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in DatasourceRawSamplesData) in the input: "
                    + str(obj)
                )
        ...
        _obj = DatasourceRawSamplesData.parse_obj(
            {
                ...
                "data": [
                    DatasourceRawSamplesDataRow.from_dict(_item)
