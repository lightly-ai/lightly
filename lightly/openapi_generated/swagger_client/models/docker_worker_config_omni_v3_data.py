...
class DockerWorkerConfigOmniV3Data(DockerWorkerConfigOmniVXDataBase):
    """
    DockerWorkerConfigOmniV3Data
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DockerWorkerConfigOmniV3Data:
        """Create an instance of DockerWorkerConfigOmniV3Data from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DockerWorkerConfigOmniV3Data:
        """Create an instance of DockerWorkerConfigOmniV3Data from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DockerWorkerConfigOmniV3Data.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DockerWorkerConfigOmniV3Data) in the input: " + str(obj))

        _obj = DockerWorkerConfigOmniV3Data.parse_obj({
            "id": obj.get("id"),
