    ...
    def from_dict(cls, obj: dict) -> DockerWorkerConfigV3:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in DockerWorkerConfigV3) in the input: "
                    + str(obj)
                )
        ...
        _obj = DockerWorkerConfigV3.parse_obj(
            {
                ...
                "docker": DockerWorkerConfigV3Docker.from_dict(obj.get("docker"))
                if obj.get("docker") is not None
                else None,
                "lightly": DockerWorkerConfigV3Lightly.from_dict(obj.get("lightly"))
                if obj.get("lightly") is not None
                else None,
                "selection": SelectionConfigV3.from_dict(obj.get("selection"))
