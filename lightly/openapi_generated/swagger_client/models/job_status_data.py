...
class JobStatusData(object):
    ...
    def __init__(self, id=None, status=None, wait_time_till_next_poll=None, created_at=None, finished_at=None, error=None, result=None):  # noqa: E501
    ...
    def wait_time_till_next_poll(self, wait_time_till_next_poll):
        ...
        :type: int
        """
        if wait_time_till_next_poll is None:
