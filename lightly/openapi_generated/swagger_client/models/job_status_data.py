...
class JobStatusData(BaseModel):
    ...
    wait_time_till_next_poll: StrictInt = Field(
        ...,
        alias="waitTimeTillNextPoll",
        description="The time in seconds the client should wait before doing the next poll.",
    )
    ...
    finished_at: Optional[conint(strict=True, ge=0)] = Field(
        None, alias="finishedAt", description="unix timestamp in milliseconds"
    )
    ...
    def to_dict(self, by_alias: bool = False):
        ...
        if self.result:
            _dict["result" if by_alias else "result"] = self.result.to_dict(
                by_alias=by_alias
            )
        return _dict
    ...
    def from_dict(cls, obj: dict) -> JobStatusData:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in JobStatusData) in the input: "
                    + str(obj)
                )
        ...
        _obj = JobStatusData.parse_obj(
            {
                ...
                "meta": JobStatusMeta.from_dict(obj.get("meta"))
                ...
                "error": obj.get("error"),
                "result": JobStatusDataResult.from_dict(obj.get("result"))
