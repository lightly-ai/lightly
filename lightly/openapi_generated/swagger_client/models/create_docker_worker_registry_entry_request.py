...
class CreateDockerWorkerRegistryEntryRequest(BaseModel):
    ...
    labels: Optional[conlist(StrictStr)] = Field(
        None, description="The labels used for specifying the run-worker-relationship"
    )
    ...
    def from_dict(cls, obj: dict) -> CreateDockerWorkerRegistryEntryRequest:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in CreateDockerWorkerRegistryEntryRequest) in the input: "
                    + str(obj)
                )
