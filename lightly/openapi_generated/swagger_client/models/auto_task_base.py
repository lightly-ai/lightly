...
class AutoTaskBase(BaseModel):
    """
    AutoTaskBase
    """
    type: StrictStr = Field(..., description="The type of the auto task")
    ...
    __discriminator_value_class_map = {
        'AutoTaskCrop': 'AutoTaskCrop',
        'AutoTaskTiling': 'AutoTaskTiling'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(AutoTaskCrop, AutoTaskTiling):
        """Create an instance of AutoTaskBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(AutoTaskCrop, AutoTaskTiling):
        """Create an instance of AutoTaskBase from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("AutoTaskBase failed to lookup discriminator value from " +
