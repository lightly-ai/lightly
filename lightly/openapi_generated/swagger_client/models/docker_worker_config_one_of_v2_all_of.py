...
class DockerWorkerConfigOneOfV2AllOf(BaseModel):
    """
    DockerWorkerConfigOneOfV2AllOf
    """
    config: DockerWorkerConfigV2 = Field(...)
    config_orig: DockerWorkerConfigV2 = Field(..., alias="configOrig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DockerWorkerConfigOneOfV2AllOf:
        """Create an instance of DockerWorkerConfigOneOfV2AllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DockerWorkerConfigOneOfV2AllOf:
        """Create an instance of DockerWorkerConfigOneOfV2AllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DockerWorkerConfigOneOfV2AllOf.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DockerWorkerConfigOneOfV2AllOf) in the input: " + str(obj))

        _obj = DockerWorkerConfigOneOfV2AllOf.parse_obj({
