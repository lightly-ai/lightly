...
class SelectionConfigV3EntryStrategy(BaseModel):
    ...
    __properties = ["type", "stopping_condition_minimum_distance", "threshold", "operation", "target", "stoppingConditionMinimumTypicality", "strength", "stoppingConditionMaxSum", "targetRange"]
