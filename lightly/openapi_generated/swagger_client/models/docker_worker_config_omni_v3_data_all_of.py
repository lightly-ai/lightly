...
class DockerWorkerConfigOmniV3DataAllOf(BaseModel):
    """
    DockerWorkerConfigOmniV3DataAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DockerWorkerConfigOmniV3DataAllOf:
        """Create an instance of DockerWorkerConfigOmniV3DataAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DockerWorkerConfigOmniV3DataAllOf:
        """Create an instance of DockerWorkerConfigOmniV3DataAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DockerWorkerConfigOmniV3DataAllOf.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DockerWorkerConfigOmniV3DataAllOf) in the input: " + str(obj))

        _obj = DockerWorkerConfigOmniV3DataAllOf.parse_obj({
