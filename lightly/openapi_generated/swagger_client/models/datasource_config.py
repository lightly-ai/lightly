...
DATASOURCECONFIG_ONE_OF_SCHEMAS = [
    "DatasourceConfigAzure",
    "DatasourceConfigGCS",
    "DatasourceConfigLIGHTLY",
    "DatasourceConfigLOCAL",
...
class DatasourceConfig(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, DatasourceConfigLIGHTLY):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DatasourceConfigLIGHTLY`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DatasourceConfigS3):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DatasourceConfigS3`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DatasourceConfigS3DelegatedAccess):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DatasourceConfigS3DelegatedAccess`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DatasourceConfigGCS):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DatasourceConfigGCS`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DatasourceConfigAzure):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DatasourceConfigAzure`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DatasourceConfigOBS):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DatasourceConfigOBS`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DatasourceConfigLOCAL):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DatasourceConfigLOCAL`"
            )
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in DatasourceConfig with oneOf schemas: DatasourceConfigAzure, DatasourceConfigGCS, DatasourceConfigLIGHTLY, DatasourceConfigLOCAL, DatasourceConfigOBS, DatasourceConfigS3, DatasourceConfigS3DelegatedAccess. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in DatasourceConfig with oneOf schemas: DatasourceConfigAzure, DatasourceConfigGCS, DatasourceConfigLIGHTLY, DatasourceConfigLOCAL, DatasourceConfigOBS, DatasourceConfigS3, DatasourceConfigS3DelegatedAccess. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> DatasourceConfig:
        ...
        if _data_type == "DatasourceConfigS3DelegatedAccess":
            instance.actual_instance = DatasourceConfigS3DelegatedAccess.from_json(
                json_str
            )
            return instance
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into DatasourceConfig with oneOf schemas: DatasourceConfigAzure, DatasourceConfigGCS, DatasourceConfigLIGHTLY, DatasourceConfigLOCAL, DatasourceConfigOBS, DatasourceConfigS3, DatasourceConfigS3DelegatedAccess. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into DatasourceConfig with oneOf schemas: DatasourceConfigAzure, DatasourceConfigGCS, DatasourceConfigLIGHTLY, DatasourceConfigLOCAL, DatasourceConfigOBS, DatasourceConfigS3, DatasourceConfigS3DelegatedAccess. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
