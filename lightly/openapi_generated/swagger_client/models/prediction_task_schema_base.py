...
class PredictionTaskSchemaBase(BaseModel):
    ...
    type: StrictStr = Field(
        ...,
        description="This is the TaskType. Due to openapi.oneOf fuckery with discriminators, this needs to be a string",
    )
    ...
    def from_json(
        cls, json_str: str
    ) -> Union(PredictionTaskSchemaKeypoint, PredictionTaskSchemaSimple):
    ...
    def from_dict(
        ...
        if object_type:
            ...
            raise ValueError(
                "PredictionTaskSchemaBase failed to lookup discriminator value from "
                + json.dumps(obj)
