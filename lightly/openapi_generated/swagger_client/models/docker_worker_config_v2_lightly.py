    ...
    def from_dict(cls, obj: dict) -> DockerWorkerConfigV2Lightly:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in DockerWorkerConfigV2Lightly) in the input: "
                    + str(obj)
                )
        ...
        _obj = DockerWorkerConfigV2Lightly.parse_obj(
            {
                ...
                "model": DockerWorkerConfigV2LightlyModel.from_dict(obj.get("model"))
                if obj.get("model") is not None
                else None,
                "trainer": DockerWorkerConfigV2LightlyTrainer.from_dict(
                    obj.get("trainer")
                )
                ...
                "collate": DockerWorkerConfigV2LightlyCollate.from_dict(
                    obj.get("collate")
                )
