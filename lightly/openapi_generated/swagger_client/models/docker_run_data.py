...
class DockerRunData(BaseModel):
    ...
    message: Optional[StrictStr] = Field(
        None, description="last message sent to the docker run"
    )
    artifacts: Optional[conlist(DockerRunArtifactData)] = Field(
        None, description="list of artifacts that were created for a run"
    )
    __properties = [
        "id",
        "userId",
    ...
    def from_dict(cls, obj: dict) -> DockerRunData:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in DockerRunData) in the input: "
                    + str(obj)
                )
        ...
        _obj = DockerRunData.parse_obj(
            {
                ...
                "artifacts": [
                    DockerRunArtifactData.from_dict(_item)
                    for _item in obj.get("artifacts")
                ]
