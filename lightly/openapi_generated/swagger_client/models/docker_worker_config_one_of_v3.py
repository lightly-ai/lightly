...
class DockerWorkerConfigOneOfV3(BaseModel):
    """
    DockerWorkerConfigOneOfV3
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DockerWorkerConfigOneOfV3:
        """Create an instance of DockerWorkerConfigOneOfV3 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DockerWorkerConfigOneOfV3:
        """Create an instance of DockerWorkerConfigOneOfV3 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DockerWorkerConfigOneOfV3.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DockerWorkerConfigOneOfV3) in the input: " + str(obj))

        _obj = DockerWorkerConfigOneOfV3.parse_obj({
            "id": obj.get("id"),
