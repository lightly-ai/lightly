...
from lightly.openapi_generated.swagger_client.exceptions import ApiTypeError, ApiValueError
from lightly.openapi_generated.swagger_client.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
