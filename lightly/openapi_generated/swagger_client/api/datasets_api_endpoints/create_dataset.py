...
# body param
SchemaForRequestBodyApplicationJson = DatasetCreateRequest


request_body_dataset_create_request = api_client.RequestBody(
    content={
...
class CreateDataset(api_client.Api):
    ...
    def create_dataset(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_dataset_create_request.serialize(body, content_type)
