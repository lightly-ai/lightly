...
# body param
SchemaForRequestBodyApplicationJson = JobStatusMeta


request_body_job_status_meta = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/registerDatasetUpload'
_method = 'PUT'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class RegisterDatasetUploadById(api_client.Api):
    ...
    def register_dataset_upload_by_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_job_status_meta.serialize(body, content_type)
