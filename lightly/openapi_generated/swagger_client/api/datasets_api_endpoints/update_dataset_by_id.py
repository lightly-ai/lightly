...
# body param
SchemaForRequestBodyApplicationJson = DatasetUpdateRequest


request_body_dataset_update_request = api_client.RequestBody(
    content={
...
class UpdateDatasetById(api_client.Api):
    ...
    def update_dataset_by_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_dataset_update_request.serialize(body, content_type)
