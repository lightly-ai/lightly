...
request_query_shared = api_client.QueryParameter(
    name="shared",
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['DatasetDataEnriched']:
        return DatasetDataEnriched
...
class GetDatasetsEnriched(api_client.Api):
