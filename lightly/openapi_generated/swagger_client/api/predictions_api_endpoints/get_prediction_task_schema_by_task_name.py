...
request_path_task_name = api_client.PathParameter(
    name="taskName",
    schema=TaskNameSchema,
    required=True,
)
_path = '/v1/datasets/{datasetId}/predictions/tasks/{taskName}'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = PredictionTaskSchema
...
class GetPredictionTaskSchemaByTaskName(api_client.Api):
