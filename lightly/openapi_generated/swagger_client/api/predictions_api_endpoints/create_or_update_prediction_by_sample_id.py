...
# body param
SchemaForRequestBodyApplicationJson = PredictionSingletons


request_body_prediction_singletons = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/predictions/samples/{sampleId}'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class CreateOrUpdatePredictionBySampleId(api_client.Api):
    ...
    def create_or_update_prediction_by_sample_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_prediction_singletons.serialize(body, content_type)
