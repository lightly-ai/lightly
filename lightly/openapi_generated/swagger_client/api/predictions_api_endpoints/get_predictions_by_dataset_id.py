...
request_query_task_name = api_client.QueryParameter(
    name="taskName",
...
_path = '/v1/datasets/{datasetId}/predictions/samples'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['PredictionSingletons']:
...
class GetPredictionsByDatasetId(api_client.Api):
