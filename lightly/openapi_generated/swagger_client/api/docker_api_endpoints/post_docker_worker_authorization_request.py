...
# body param
SchemaForRequestBodyApplicationJson = DockerWorkerAuthorizationRequest


request_body_docker_worker_authorization_request = api_client.RequestBody(
    content={
...
_path = '/v1/docker/workerAuthorization'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class PostDockerWorkerAuthorizationRequest(api_client.Api):
    ...
    def post_docker_worker_authorization_request(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_docker_worker_authorization_request.serialize(body, content_type)
