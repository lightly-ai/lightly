...
WorkerIdSchema = MongoObjectID
ScheduledIdSchema = MongoObjectID
...
request_path_scheduled_id = api_client.PathParameter(
    name="scheduledId",
    schema=ScheduledIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = DockerRunScheduledUpdateRequest


request_body_docker_run_scheduled_update_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/docker/worker/{workerId}/schedule/{scheduledId}'
_method = 'PUT'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class UpdateScheduledDockerRunStateById(api_client.Api):
    ...
    def update_scheduled_docker_run_state_by_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_docker_run_scheduled_update_request.serialize(body, content_type)
