...
# body param
SchemaForRequestBodyApplicationJson = DockerRunScheduledCreateRequest


request_body_docker_run_scheduled_create_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/docker/worker/schedule'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class CreateDockerRunScheduledByDatasetId(api_client.Api):
    ...
    def create_docker_run_scheduled_by_dataset_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_docker_run_scheduled_create_request.serialize(body, content_type)
