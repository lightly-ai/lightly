...
# body param
SchemaForRequestBodyApplicationJson = DockerRunUpdateRequest


request_body_docker_run_update_request = api_client.RequestBody(
    content={
...
class UpdateDockerRunById(api_client.Api):
    ...
    def update_docker_run_by_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_docker_run_update_request.serialize(body, content_type)
