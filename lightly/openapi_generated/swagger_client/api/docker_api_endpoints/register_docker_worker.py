...
# body param
SchemaForRequestBodyApplicationJson = CreateDockerWorkerRegistryEntryRequest


request_body_create_docker_worker_registry_entry_request = api_client.RequestBody(
    content={
...
class RegisterDockerWorker(api_client.Api):
    ...
    def register_docker_worker(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_docker_worker_registry_entry_request.serialize(body, content_type)
