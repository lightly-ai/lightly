...
# body param
SchemaForRequestBodyApplicationJson = DockerWorkerConfigCreateRequest


request_body_docker_worker_config_create_request = api_client.RequestBody(
    content={
...
class CreateDockerWorkerConfig(api_client.Api):
    ...
    def create_docker_worker_config(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_docker_worker_config_create_request.serialize(body, content_type)
