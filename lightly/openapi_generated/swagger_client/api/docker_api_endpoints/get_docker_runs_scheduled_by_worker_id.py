...
# query params
StateSchema = DockerRunScheduledState
...
_path = '/v1/docker/worker/{workerId}/schedule'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['DockerRunScheduledData']:
        return DockerRunScheduledData
...
class GetDockerRunsScheduledByWorkerId(api_client.Api):
