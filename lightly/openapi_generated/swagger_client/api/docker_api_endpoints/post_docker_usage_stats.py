...
# body param
SchemaForRequestBodyApplicationJson = DockerUserStats


request_body_docker_user_stats = api_client.RequestBody(
    content={
...
class PostDockerUsageStats(api_client.Api):
    ...
    def post_docker_usage_stats(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_docker_user_stats.serialize(body, content_type)
