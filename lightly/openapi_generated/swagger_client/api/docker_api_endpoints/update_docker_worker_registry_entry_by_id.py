...
# body param
SchemaForRequestBodyApplicationJson = UpdateDockerWorkerRegistryEntryRequest


request_body_update_docker_worker_registry_entry_request = api_client.RequestBody(
    content={
...
_path = '/v1/docker/worker/{workerId}'
_method = 'PUT'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class UpdateDockerWorkerRegistryEntryById(api_client.Api):
    ...
    def update_docker_worker_registry_entry_by_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_docker_worker_registry_entry_request.serialize(body, content_type)
