...
class SamplingsApi(object):
    ...
    def trigger_sampling_by_id(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the trigger_sampling_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.trigger_sampling_by_id_with_http_info(
            dataset_id, embedding_id, sampling_create_request, **kwargs
        )  # noqa: E501
    ...
    def trigger_sampling_by_id_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["dataset_id", "embedding_id", "sampling_create_request"]
        _all_params.extend(
            [
                "async_req",
