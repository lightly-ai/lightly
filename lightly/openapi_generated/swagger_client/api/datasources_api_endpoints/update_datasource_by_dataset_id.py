...
# body param
SchemaForRequestBodyApplicationJson = DatasourceConfig


request_body_datasource_config = api_client.RequestBody(
    content={
...
class UpdateDatasourceByDatasetId(api_client.Api):
    ...
    def update_datasource_by_dataset_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_datasource_config.serialize(body, content_type)
