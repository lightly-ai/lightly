...
# body param
SchemaForRequestBodyApplicationJson = DatasourceProcessedUntilTimestampRequest


request_body_datasource_processed_until_timestamp_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/datasource/processedUntilTimestamp'
_method = 'PUT'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class UpdateDatasourceProcessedUntilTimestampByDatasetId(api_client.Api):
    ...
    def update_datasource_processed_until_timestamp_by_dataset_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_datasource_processed_until_timestamp_request.serialize(body, content_type)
