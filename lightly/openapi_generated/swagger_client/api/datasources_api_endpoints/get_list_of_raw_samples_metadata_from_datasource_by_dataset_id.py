...
_path = '/v1/datasets/{datasetId}/datasource/metadata/list'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = DatasourceRawSamplesMetadataData
...
class GetListOfRawSamplesMetadataFromDatasourceByDatasetId(api_client.Api):
