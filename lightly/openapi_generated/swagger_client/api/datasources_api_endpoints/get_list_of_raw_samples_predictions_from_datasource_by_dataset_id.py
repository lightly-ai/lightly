...
_path = '/v1/datasets/{datasetId}/datasource/predictions/list'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = DatasourceRawSamplesPredictionsData
...
class GetListOfRawSamplesPredictionsFromDatasourceByDatasetId(api_client.Api):
