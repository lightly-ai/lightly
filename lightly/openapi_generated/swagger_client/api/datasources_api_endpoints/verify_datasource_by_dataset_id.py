...
_path = '/v1/datasets/{datasetId}/datasource/verify'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = DatasourceConfigVerifyData
...
class VerifyDatasourceByDatasetId(api_client.Api):
