...
_path = '/v1/datasets/{datasetId}/datasource/list'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = DatasourceRawSamplesData
...
class GetListOfRawSamplesFromDatasourceByDatasetId(api_client.Api):
