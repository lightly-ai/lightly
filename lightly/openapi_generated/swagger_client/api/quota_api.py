...
class QuotaApi(object):
    ...
    def get_quota_maximum_dataset_size(self, **kwargs) -> str:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_quota_maximum_dataset_size_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    @validate_arguments
    def get_quota_maximum_dataset_size_with_http_info(
        self, **kwargs
