...
class TeamsApi(object):
    ...
    def get_service_accounts_by_team_id(self, team_id, **kwargs):  # noqa: E501
        ...
        :param MongoObjectID team_id: id of the team (required)
        :return: list[ProfileBasicData]
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_service_accounts_by_team_id_with_http_info(team_id, **kwargs)  # noqa: E501
            return data

    def get_service_accounts_by_team_id_with_http_info(self, team_id, **kwargs):  # noqa: E501
        """get_service_accounts_by_team_id  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_service_accounts_by_team_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('team_id' not in params or
            ...
            raise ValueError("Missing the required parameter `team_id` when calling `get_service_accounts_by_team_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='list[ProfileBasicData]',  # noqa: E501
    ...
    def get_team_by_id_with_http_info(self, team_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TeamData',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_team_members_by_id(self, team_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_team_members_by_id_with_http_info(team_id, **kwargs)  # noqa: E501
            return data

    def get_team_members_by_id_with_http_info(self, team_id, **kwargs):  # noqa: E501
        """get_team_members_by_id  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_team_members_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'team_id' is set
        if self.api_client.client_side_validation and ('team_id' not in params or
                                                       params['team_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `team_id` when calling `get_team_members_by_id`")  # noqa: E501
