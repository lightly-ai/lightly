...
ConfigurationIdSchema = MongoObjectID
...
request_path_configuration_id = api_client.PathParameter(
    name="configurationId",
    schema=ConfigurationIdSchema,
    required=True,
)
# body param
...
_path = '/v1/datasets/{datasetId}/configuration/metadata/{configurationId}'
_method = 'PUT'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class UpdateMetaDataConfigurationById(api_client.Api):
