...
# body param
SchemaForRequestBodyApplicationJson = ActiveLearningScoreCreateRequest


request_body_active_learning_score_create_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/tags/{tagId}/scores'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class CreateOrUpdateActiveLearningScoreByTagId(api_client.Api):
    ...
    def create_or_update_active_learning_score_by_tag_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_active_learning_score_create_request.serialize(body, content_type)
