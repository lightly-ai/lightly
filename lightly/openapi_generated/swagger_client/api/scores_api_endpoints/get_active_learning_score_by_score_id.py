...
_path = '/v1/datasets/{datasetId}/tags/{tagId}/scores/{scoreId}'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = ActiveLearningScoreData
...
class GetActiveLearningScoreByScoreId(api_client.Api):
