...
class FieldSchema(
    ...
    @property
    def _ID(cls):
        return cls._enum_by_value["_id"]("_id")
    
    @classmethod
    @property
    def FILENAME(cls):
        return cls._enum_by_value["fileName"]("fileName")
...
_path = '/v1/datasets/{datasetId}/mappings'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class GetSampleMappingsByDatasetId(api_client.Api):
