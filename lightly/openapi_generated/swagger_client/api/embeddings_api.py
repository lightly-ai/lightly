...
class EmbeddingsApi(object):
    ...
    def delete_embedding_by_id(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the delete_embedding_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.delete_embedding_by_id_with_http_info(
            dataset_id, embedding_id, **kwargs
        )  # noqa: E501

    @validate_arguments
    def delete_embedding_by_id_with_http_info(
        self,
        dataset_id: Annotated[
            constr(strict=True), Field(..., description="ObjectId of the dataset")
        ],
    ...
    def get_embeddings_by_dataset_id(
        ...
        **kwargs
    ) -> List[DatasetEmbeddingData]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_embeddings_by_dataset_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    def get_embeddings_by_sample_id(
        ...
        mode: Annotated[
            Optional[StrictStr],
            Field(description="if we want everything (full) or just the summaries"),
        ] = None,
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_embeddings_by_sample_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_embeddings_by_sample_id_with_http_info(
            dataset_id, sample_id, mode, **kwargs
        )  # noqa: E501
    ...
    def get_embeddings_by_sample_id_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["dataset_id", "sample_id", "mode"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def get_embeddings_csv_read_url_by_id(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_embeddings_csv_read_url_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    def get_embeddings_csv_write_url_by_id(
        ...
        name: Annotated[
            Optional[StrictStr],
            Field(description="the sampling requests name to create a signed url for"),
        ] = None,
        **kwargs
    ) -> WriteCSVUrlData:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_embeddings_csv_write_url_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_embeddings_csv_write_url_by_id_with_http_info(
            dataset_id, name, **kwargs
        )  # noqa: E501
    ...
    def set_embeddings_is_processed_flag_by_id(
        ...
        set_embeddings_is_processed_flag_by_id_body_request: SetEmbeddingsIsProcessedFlagByIdBodyRequest,
        **kwargs
    ) -> None:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the set_embeddings_is_processed_flag_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    def trigger2d_embeddings_job(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the trigger2d_embeddings_job_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.trigger2d_embeddings_job_with_http_info(
            dataset_id, embedding_id, trigger2d_embedding_job_request, **kwargs
        )  # noqa: E501
    ...
    def trigger2d_embeddings_job_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["dataset_id", "embedding_id", "trigger2d_embedding_job_request"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
