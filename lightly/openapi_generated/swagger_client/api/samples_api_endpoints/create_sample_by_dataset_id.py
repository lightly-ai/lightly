...
# body param
SchemaForRequestBodyApplicationJson = SampleCreateRequest


request_body_sample_create_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/samples'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class CreateSampleByDatasetId(api_client.Api):
    ...
    def create_sample_by_dataset_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sample_create_request.serialize(body, content_type)
