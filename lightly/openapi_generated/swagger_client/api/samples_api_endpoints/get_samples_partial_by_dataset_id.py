...
_path = '/v1/datasets/{datasetId}/samples/partial'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['SampleDataModes']:
        return SampleDataModes
...
class GetSamplesPartialByDatasetId(api_client.Api):
