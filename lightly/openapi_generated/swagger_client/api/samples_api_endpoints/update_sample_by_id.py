...
# query params
EnableDatasetUpdateSchema = BoolSchema
...
RequestOptionalQueryParams = typing.TypedDict(
    ...
    {
        'enableDatasetUpdate': EnableDatasetUpdateSchema,
    },
    total=False
)
...
request_query_enable_dataset_update = api_client.QueryParameter(
    name="enableDatasetUpdate",
    style=api_client.ParameterStyle.FORM,
    schema=EnableDatasetUpdateSchema,
    explode=True,
)
# path params
...
# body param
SchemaForRequestBodyApplicationJson = SampleUpdateRequest


request_body_sample_update_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/samples/{sampleId}'
_method = 'PUT'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class UpdateSampleById(api_client.Api):
    ...
    def update_sample_by_id(
        ...
        _query_params = []
        for parameter in (
            request_query_enable_dataset_update,
        ):
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sample_update_request.serialize(body, content_type)
