...
class TypeSchema(
    ...
    @property
    def THUMBNAIL(cls):
        return cls._enum_by_value["thumbnail"]("thumbnail")
...
_path = '/v1/datasets/{datasetId}/samples/{sampleId}/readurlRedirect'
_method = 'GET'
_auth = [
    'ApiPublicJWTAuth',
]
...
class GetSampleImageResourceRedirectById(api_client.Api):
