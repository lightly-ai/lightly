...
request_query_is_thumbnail = api_client.QueryParameter(
    name="isThumbnail",
    style=api_client.ParameterStyle.FORM,
    schema=IsThumbnailSchema,
    required=True,
    explode=True,
)
# path params
...
_path = '/v1/datasets/{datasetId}/samples/{sampleId}/writeurl'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class GetSampleImageWriteUrlById(api_client.Api):
