...
_path = '/v1/datasets/{datasetId}/samples/{sampleId}/writeurls'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = SampleWriteUrls
...
class GetSampleImageWriteUrlsById(api_client.Api):
