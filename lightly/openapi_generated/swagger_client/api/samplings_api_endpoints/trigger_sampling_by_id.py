...
# body param
SchemaForRequestBodyApplicationJson = SamplingCreateRequest


request_body_sampling_create_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/embeddings/{embeddingId}/sampling'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = AsyncTaskData
...
class TriggerSamplingById(api_client.Api):
    ...
    def trigger_sampling_by_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sampling_create_request.serialize(body, content_type)
