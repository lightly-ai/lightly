...
_path = '/v1/datasets/{datasetId}/embeddings/writeCSVUrl'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = WriteCSVUrlData
...
class GetEmbeddingsCsvWriteUrlById(api_client.Api):
