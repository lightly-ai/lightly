...
# body param
SchemaForRequestBodyApplicationJson = Trigger2dEmbeddingJobRequest


request_body_trigger2d_embedding_job_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/embeddings/{embeddingId}/trigger2dEmbeddingsJob'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class Trigger2dEmbeddingsJob(api_client.Api):
    ...
    def trigger2d_embeddings_job(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_trigger2d_embedding_job_request.serialize(body, content_type)
