...
Embedding2dIdSchema = MongoObjectID
...
request_path_embedding2d_id = api_client.PathParameter(
    name="embedding2dId",
    schema=Embedding2dIdSchema,
    required=True,
)
_path = '/v1/datasets/{datasetId}/embeddings/{embeddingId}/2d/{embedding2dId}'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = Embedding2dData
...
class GetEmbedding2dById(api_client.Api):
