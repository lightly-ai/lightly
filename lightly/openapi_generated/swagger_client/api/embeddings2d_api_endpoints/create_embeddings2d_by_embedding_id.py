...
EmbeddingIdSchema = MongoObjectID
...
request_path_embedding_id = api_client.PathParameter(
    name="embeddingId",
    schema=EmbeddingIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = Embedding2dCreateRequest


request_body_embedding2d_create_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/embeddings/{embeddingId}/2d'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class CreateEmbeddings2dByEmbeddingId(api_client.Api):
    ...
    def create_embeddings2d_by_embedding_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_embedding2d_create_request.serialize(body, content_type)
