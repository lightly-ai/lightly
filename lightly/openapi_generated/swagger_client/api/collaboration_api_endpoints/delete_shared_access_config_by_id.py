...
AccessConfigIdSchema = MongoObjectID
...
request_path_access_config_id = api_client.PathParameter(
    name="accessConfigId",
    schema=AccessConfigIdSchema,
    required=True,
)
_path = '/v1/datasets/{datasetId}/collaboration/access/{accessConfigId}'
_method = 'DELETE'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class DeleteSharedAccessConfigById(api_client.Api):
