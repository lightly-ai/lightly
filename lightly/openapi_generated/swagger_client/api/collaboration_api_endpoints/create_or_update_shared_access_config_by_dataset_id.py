...
# body param
SchemaForRequestBodyApplicationJson = SharedAccessConfigCreateRequest


request_body_shared_access_config_create_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/collaboration/access'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class CreateOrUpdateSharedAccessConfigByDatasetId(api_client.Api):
    ...
    def create_or_update_shared_access_config_by_dataset_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_shared_access_config_create_request.serialize(body, content_type)
