...
# body param
SchemaForRequestBodyApplicationJson = TagArithmeticsRequest


request_body_tag_arithmetics_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/tags/arithmetics/bitmask'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = TagBitMaskResponse
...
class PerformTagArithmeticsBitmask(api_client.Api):
    ...
    def perform_tag_arithmetics_bitmask(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_arithmetics_request.serialize(body, content_type)
