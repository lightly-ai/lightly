...
_path = '/v1/datasets/{datasetId}/tags/{tagId}/export/LabelBox/datarows'
_method = 'GET'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
]
SchemaFor200ResponseBodyApplicationJson = LabelBoxDataRows
...
class ExportTagToLabelBoxDataRows(api_client.Api):
