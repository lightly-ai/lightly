...
# body param
SchemaForRequestBodyApplicationJson = TagUpdateRequest


request_body_tag_update_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/tags/{tagId}'
_method = 'PUT'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class UpdateTagByTagId(api_client.Api):
    ...
    def update_tag_by_tag_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_update_request.serialize(body, content_type)
