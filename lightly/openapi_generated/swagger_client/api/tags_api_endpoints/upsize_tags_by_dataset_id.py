...
# body param
SchemaForRequestBodyApplicationJson = TagUpsizeRequest


request_body_tag_upsize_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/tags/upsize'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class UpsizeTagsByDatasetId(api_client.Api):
    ...
    def upsize_tags_by_dataset_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_upsize_request.serialize(body, content_type)
