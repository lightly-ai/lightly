...
# body param
SchemaForRequestBodyApplicationJson = InitialTagCreateRequest


request_body_initial_tag_create_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/tags/initial'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class CreateInitialTagByDatasetId(api_client.Api):
    ...
    def create_initial_tag_by_dataset_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_initial_tag_create_request.serialize(body, content_type)
