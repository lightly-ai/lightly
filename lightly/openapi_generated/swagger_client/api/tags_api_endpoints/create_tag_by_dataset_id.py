...
# body param
SchemaForRequestBodyApplicationJson = TagCreateRequest


request_body_tag_create_request = api_client.RequestBody(
    content={
...
_path = '/v1/datasets/{datasetId}/tags'
_method = 'POST'
_auth = [
    'ApiKeyAuth',
    'auth0Bearer',
...
class CreateTagByDatasetId(api_client.Api):
    ...
    def create_tag_by_dataset_id(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_create_request.serialize(body, content_type)
