...
from lightly.openapi_generated.swagger_client.models.docker_worker_config_one_of import DockerWorkerConfigOneOf
...
class DockerApi(object):
    ...
    @validate_arguments
    def check_if_docker_worker_config_is_schedulable(self, dataset_id : Annotated[constr(strict=True), Field(..., description="ObjectId of the dataset")], docker_worker_config_one_of : DockerWorkerConfigOneOf, **kwargs) -> CreateEntityResponse:  # noqa: E501
        """check_if_docker_worker_config_is_schedulable  # noqa: E501

        Checks if the provided configuration can be scheduled on the given dataset + datasource.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.check_if_docker_worker_config_is_schedulable(dataset_id, docker_worker_config_one_of, async_req=True)
        >>> result = thread.get()

        :param dataset_id: ObjectId of the dataset (required)
        :type dataset_id: str
        :param docker_worker_config_one_of: (required)
        :type docker_worker_config_one_of: DockerWorkerConfigOneOf
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the check_if_docker_worker_config_is_schedulable_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.check_if_docker_worker_config_is_schedulable_with_http_info(dataset_id, docker_worker_config_one_of, **kwargs)  # noqa: E501

    @validate_arguments
    def check_if_docker_worker_config_is_schedulable_with_http_info(self, dataset_id : Annotated[constr(strict=True), Field(..., description="ObjectId of the dataset")], docker_worker_config_one_of : DockerWorkerConfigOneOf, **kwargs) -> ApiResponse:  # noqa: E501
        """check_if_docker_worker_config_is_schedulable  # noqa: E501
        ...
        >>> thread = api.check_if_docker_worker_config_is_schedulable_with_http_info(dataset_id, docker_worker_config_one_of, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method check_if_docker_worker_config_is_schedulable" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['docker_worker_config_one_of'] is not None:
            _body_params = _params['docker_worker_config_one_of']
        ...
        return self.api_client.call_api(
            '/v1/datasets/{datasetId}/docker/worker/schedulable', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
