...
class ScoresApi(object):
    ...
    def create_or_update_active_learning_score_by_tag_id(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_or_update_active_learning_score_by_tag_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.create_or_update_active_learning_score_by_tag_id_with_http_info(
            dataset_id, tag_id, active_learning_score_create_request, **kwargs
        )  # noqa: E501
    ...
    def create_or_update_active_learning_score_by_tag_id_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["dataset_id", "tag_id", "active_learning_score_create_request"]
        _all_params.extend(
            [
                "async_req",
    ...
    def get_active_learning_score_by_score_id(
        ...
        score_id: Annotated[
            constr(strict=True), Field(..., description="ObjectId of the scores")
        ],
        **kwargs
    ) -> ActiveLearningScoreData:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_active_learning_score_by_score_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    def get_active_learning_score_by_score_id_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["dataset_id", "tag_id", "score_id"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def get_active_learning_scores_by_tag_id(
        ...
        **kwargs
    ) -> List[TagActiveLearningScoresData]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_active_learning_scores_by_tag_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
