...
[**get_children_of_dataset_id**](DatasetsApi.md#get_children_of_dataset_id) | **GET** /v1/datasets/{datasetId}/children | 
...
# **get_children_of_dataset_id**
> [DatasetData] get_children_of_dataset_id(dataset_id)
...
with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_children_of_dataset_id(
            path_params=path_params,
        )
        pprint(api_response)
    except swagger_client.ApiException as e:
        print("Exception when calling DatasetsApi->get_children_of_dataset_id: %s\n" % e)
```
### Parameters
