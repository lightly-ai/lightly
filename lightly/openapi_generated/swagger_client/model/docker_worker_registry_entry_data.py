...
class DockerWorkerRegistryEntryData(
    DictSchema
):
    ...
    @classmethod
    @property
    def name(cls) -> typing.Type['DockerWorkerName']:
        return DockerWorkerName
    ...
    @classmethod
    @property
    def state(cls) -> typing.Type['DockerWorkerState']:
        return DockerWorkerState
