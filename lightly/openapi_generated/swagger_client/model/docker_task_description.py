...
class DockerTaskDescription(
    ...
    embeddingsFilename = StrSchema
    embeddingsHash = StrSchema

    @classmethod
    @property
    def method(cls) -> typing.Type['SamplingMethod']:
        return SamplingMethod
    existingSelectionColumnName = StrSchema
    activeLearningScoresColumnName = StrSchema
    maskedOutColumnName = StrSchema

    @classmethod
    @property
    def samplingConfig(cls) -> typing.Type['SamplingConfig']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        method: method,
        existingSelectionColumnName: existingSelectionColumnName,
        activeLearningScoresColumnName: activeLearningScoresColumnName,
        maskedOutColumnName: maskedOutColumnName,
