...
class PredictionTaskSchema(
    ...
    @classmethod
    @property
    def name(cls) -> typing.Type['PathSafeName']:
        return PathSafeName

    @classmethod
    @property
    def type(cls) -> typing.Type['TaskType']:
        return TaskType
    ...
    class categories(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['PredictionTaskSchemaCategory']:
            return PredictionTaskSchemaCategory
