...
class DockerRunData(
    ...
    class messages(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['DockerRunDataLog']:
            return DockerRunDataLog
    reportAvailable = BoolSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        messages: typing.Union[messages, Unset] = unset,
        reportAvailable: typing.Union[reportAvailable, Unset] = unset,
