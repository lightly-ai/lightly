...
class PredictionSingleton(
    ...
    def _discriminator(cls):
        return {
            'type': {
                'CLASSIFICATION': PredictionSingletonClassification,
                'INSTANCE_SEGMENTATION': PredictionSingletonInstanceSegmentation,
                'KEYPOINT_DETECTION': PredictionSingletonKeypointDetection,
                'OBJECT_DETECTION': PredictionSingletonObjectDetection,
