...
class PixioDecoderTIMM(MAEDecoderTIMM):
    ...
    (32 blocks vs. 8), moving pixel-level detail modeling from the encoder into the
    decoder. Architecturally it is a :class:`MAEDecoderTIMM` with a deeper default
    stack and support for multiple prefix (class) tokens. Implemented from the paper;
