...
class LeJEPATransform(MultiViewTransform):
    """Implements the global and local view augmentations for LeJEPA [0].

    Output of this transform:
        List of Tensor of length 2 + n_local_views.

    This class generates two global and a user defined number of local views for
    each image in a batch using a DINO/iBOT-style augmentation recipe.

    - [0]: LeJEPA: Provable and Scalable Self-Supervised Learning Without the
      Heuristics, 2025, https://arxiv.org/abs/2511.08544
    - [1]: Minimal Example, https://github.com/galilai-group/lejepa/blob/main/MINIMAL.md
    ...
    def __init__(
        ...
        # first global crop
        global_transform_0 = LeJEPAViewTransform(
        ...
        # second global crop
        global_transform_1 = LeJEPAViewTransform(
            crop_size=global_crop_size,
            crop_scale=global_crop_scale,
            hf_prob=hf_prob,
            vf_prob=vf_prob,
        ...
        local_transform = LeJEPAViewTransform(
