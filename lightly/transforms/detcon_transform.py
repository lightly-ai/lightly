...
from lightly.transforms import torchvision_transforms as T
...
class DetConSTransform(MultiViewTransformV2):
    """Implements the transformations for DetConS[0]_, based on SimCLR.[1]
