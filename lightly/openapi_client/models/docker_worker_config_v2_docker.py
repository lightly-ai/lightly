...
class DockerWorkerConfigV2Docker(BaseModel):
    ...
    def to_dict(self):
        ...
        if self.corruptness_check:
            _dict['corruptnessCheck'] = self.corruptness_check.to_dict()
        ...
        if self.object_level:
            _dict['objectLevel'] = self.object_level.to_dict()
        # override the default output from pydantic by calling `to_dict()` of stopping_condition
        if self.stopping_condition:
            _dict['stoppingCondition'] = self.stopping_condition.to_dict()
        return _dict
