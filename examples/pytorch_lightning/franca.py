...
class Franca(pl.LightningModule):
    def __init__(
        ...
        # Losses. The nested prototype counts come from the head.
        self.dino_criterion = FrancaDINOLoss(output_dims=student_dino_head.output_dims)
        self.ibot_criterion = FrancaIBOTPatchLoss(
            output_dims=student_ibot_head.output_dims
        )
